<x-app-layout>
   <x-slot name="header">
      <h1 class="font-title text-4xl m-4">home page</h1>
   ...
   <section class="flex flex-col justify-center items-center">
      <h2 class="self-start font-title text-2xl m-3">fonctionnalitées</h2>
      <a href="" class="w-11/12 my-10">
         <article
            ...
            <img src="./img_folder/waldemar-RGumRVmV0MY-unsplash.jpg" alt="/" class="w-12/12 min-h-40 lg:w-3/12  p-2">
